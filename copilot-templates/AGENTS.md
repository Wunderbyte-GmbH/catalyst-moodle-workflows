<!--
Generated from Wunderbyte-GmbH/catalyst-moodle-workflows/copilot-templates
Do not edit this file manually in this repository.
Update the shared template and re-run sync instead.
-->
...
Component mapping for this repository: `plugintype` -> `{{PLUGINTYPE}}`.
...
/
├── .github/
│   └── copilot-instructions.md   # Repository-wide Copilot coding instructions
├── amd/
